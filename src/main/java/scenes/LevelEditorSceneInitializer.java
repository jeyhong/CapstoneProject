...
public class LevelEditorSceneInitializer extends SceneInitializer {
    ...
    public void init(Scene scene) {
        ...
        Spritesheet widget = AssetPool.getSpritesheet("assets/images/widget.png");

        levelEditorStuff = scene.createGameObj("LevelEditor");
        levelEditorStuff.setNoSerialize();
        levelEditorStuff.addComponent(new MouseControls());
        levelEditorStuff.addComponent(new KeyControls());
        levelEditorStuff.addComponent(new GridLines());
        levelEditorStuff.addComponent(new EditorCamera(scene.camera()));
        levelEditorStuff.addComponent(new WidgetSystem(widget));
        scene.addGameObjToScene(levelEditorStuff);
    }
    ...
    public void loadResources(Scene scene) {
        ...
        AssetPool.addSpritesheet("assets/images/items.png",
                new Spritesheet(AssetPool.getTexture("assets/images/items.png"),
                        16, 16, 43, 0));
        AssetPool.addSpritesheet("assets/images/widget.png",
                new Spritesheet(AssetPool.getTexture("assets/images/widget.png"),
                        24, 48, 3, 0));

        //non mario sprite
        AssetPool.addSpritesheet("assets/images/enemies.png",
                new Spritesheet(AssetPool.getTexture("assets/images/enemies.png"),
                        16, 16, 81, 0));
        ...
        for (GameObject g : scene.getGameObjs()) {
