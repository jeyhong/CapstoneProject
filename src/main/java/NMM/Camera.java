...
public class Camera {
    ...
    private Vector2f projSize = new Vector2f(projectionWidth,  projectionHeight);
    ...
    public void adjustProjection(){
        ...
        projectionMatrix.ortho(0.0f, projSize.x * this.zoom, 0.0f, projSize.y * this.zoom, 0.0f, 100.0f);
