...
public class Physics2D {
    ...
    public void add(GameObj go){
        ...
        if(rb != null && rb.getRawBody() == null){
            ...
            bodyDef.angularDamping = rb.getAngularDamping(); //damping is friction
            bodyDef.linearDamping = rb.getLinearDamping();
            bodyDef.fixedRotation = rb.isFixedRotation();
            bodyDef.bullet = rb.isContinuousCollision(); //should stop ghosting
    ...
    public void update(float dt){
        ...
        if(physicsTime >= 0.0f){
            ...
            world.step(physicsTimeStep, velocityIterations, posIterations);
        }
    }
}
